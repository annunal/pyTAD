...
OPTIONS0='-w 1280 -h 960 -n -e jpg -q 50 -co 50 -ex auto'
MINDIM=100000
...
if [[ $Nhou -ge $Nhou0 && $Nhou -lt $Nhou1 ]];then
  ...
  echo 'notte'
  NIGHTMODE=.true.
  OPTIONS1=' -ISO 2000 -ss 7000000 -br 85 -co 100 -e jpg -vs'
fi

# da cambiare con le stagioni
#if [[ $NHour -ge 1730 || $NHour -lt 500 ]];then

  #OPTIONS='-w 1280 -h 960 -n -e jpg -q 50 -ex night'
  #OPTIONS='-w 1280 -h 960 -n -e jpg -q 50 -ex night'
  #OPTIONS='-w 1280 -h 960 -ISO 800 -ss 6000000 -br 80 -co 100 -e jpg'
  #OPTIONS1=' -ISO 2000 -ss 7000000 -br 78 -co 100 -e jpg -vs'
#fi
